...
Students also learn how to organize and document a programs source code so that it effectively communicates with the
...
discovering how to use single-dimension, multi-dimensional, and extendable arrays and to implement graphical
